...
import { User, Building, Phone, Mail, Briefcase, ArrowRight } from "lucide-react"
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Review and complete your information. You can always edit this later.</CardDescription>
      </CardHeader>
      <CardContent>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-muted-foreground">Let others know how you'd like to connect and collaborate</p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {[
